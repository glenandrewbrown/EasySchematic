...
// Rack face constants — must mirror RackRenderer.tsx exactly.
// Exported so callers can position interactive overlays (drag indicators, badges, etc.)
// against the same coordinate system the SVG body uses.
